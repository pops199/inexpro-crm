...
const MODULES = {
  ...
  popia: {
    label: 'POPIA',
    columns: [
      { id: 'name',                     label: 'Contact',              sortable: true,  defaultVisible: true  },
      { id: 'status_badge',             label: 'Status',               sortable: true,  defaultVisible: true  },
      { id: 'data_processing_basis',    label: 'Processing Basis',     sortable: true,  defaultVisible: true  },
      { id: 'popia_consent_date',       label: 'Consent Date',         sortable: true,  defaultVisible: true  },
      { id: 'consent_method',           label: 'Consent Method',       sortable: true,  defaultVisible: false },
      { id: 'information_officer_name', label: 'Information Officer',  sortable: true,  defaultVisible: true  },
      { id: 'retention_expiry_date',    label: 'Retention Expires',    sortable: true,  defaultVisible: true  },
      { id: 'direct_marketing_consent', label: 'Direct Marketing',     sortable: true,  defaultVisible: false },
      { id: 'third_party_sharing',      label: '3rd Party Sharing',    sortable: true,  defaultVisible: false },
      { id: 'privacy_notice_provided',  label: 'Privacy Notice',       sortable: true,  defaultVisible: false },
      { id: 'data_source',              label: 'Data Source',          sortable: true,  defaultVisible: false },
      { id: 'email',                    label: 'Email',                sortable: true,  defaultVisible: false },
      { id: 'mobile',                   label: 'Mobile',               sortable: true,  defaultVisible: false },
      { id: 'actions',                  label: 'Actions',              sortable: false, defaultVisible: true  },
    ],
    sortAllowlist: {},
    defaultSort: { sortBy: 'name', sortDir: 'asc' },
  ...
  fica: {
    ...
    columns: [
      { id: 'name',                            label: 'Contact',           sortable: true,  defaultVisible: true  },
      { id: 'derived_status',                  label: 'Status',            sortable: true,  defaultVisible: true  },
      { id: 'fica_verification_date',          label: 'Verification Date', sortable: true,  defaultVisible: true  },
      { id: 'fica_verification_method',        label: 'Method',            sortable: true,  defaultVisible: true  },
      { id: 'fica_verified_by_name',           label: 'Verified By',       sortable: true,  defaultVisible: true  },
      { id: 'fica_five_year_expiry',           label: '5-Year Expiry',     sortable: true,  defaultVisible: true  },
      { id: 'fica_pep_check',                  label: 'PEP Check',         sortable: true,  defaultVisible: true  },
      { id: 'fica_document_reference',         label: 'Document Ref',      sortable: false, defaultVisible: false },
      { id: 'fica_cipc_number',                label: 'CIPC Number',       sortable: true,  defaultVisible: false },
      { id: 'fica_beneficial_owner_confirmed', label: 'Beneficial Owner',  sortable: true,  defaultVisible: false },
      { id: 'fica_pep_check_date',             label: 'PEP Check Date',    sortable: true,  defaultVisible: false },
      { id: 'sa_id_number',                    label: 'SA ID Number',      sortable: true,  defaultVisible: false },
      { id: 'email',                           label: 'Email',             sortable: true,  defaultVisible: false },
      { id: 'actions',                         label: 'Actions',           sortable: false, defaultVisible: true  },
    ],
    sortAllowlist: {},
